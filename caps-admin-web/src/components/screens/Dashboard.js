...
export const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchCounts = async () => {
      setIsLoading(true);
      try {
        const { counts: countsData, bookings: bookingsData } = await userService.getDashboardCounts();
    ...
    <div className="flex h-screen">
      ...
      <div className="flex flex-col w-full">
        ...
        <main className="flex-grow p-4 bg-gray-100 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h2 className="text-xl font-bold mb-4 flex justify-between items-center">
                Earnings Overview
                <button onClick={toggleEarningsVisibility} className="text-blue-500 underline">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-2xl font-bold">
                    {areEarningsVisible ? `₱1,00${stats.weeklyEarnings}` : '****'}
                  </p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <p className="text-gray-600">Monthly Earnings</p>
                  <p className="text-2xl font-bold">
                    {areEarningsVisible ? `₱30,00${stats.monthlyEarnings}` : '****'}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-2xl font-bold">{stats.avgRideDistance} km</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
          ...
          {/* Recent Bookings */}
          <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col h-[calc(100vh-540px)] min-h-[300px]">
