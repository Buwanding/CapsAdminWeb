  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-col w-full">
        <Header />
        <main className="flex-grow p-3 bg-gray-100 overflow-hidden">
          {/* Stats Overview */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-3">
            ...
            {userRole !== 1 ? (
              ...
              <div className="animate__animated animate__fadeIn bg-yellow-500 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-200">
              <h2 className="text-xl font-bold text-white mb-2">Active Admins</h2>
              <p className="text-4xl font-bold text-white mb-2">{counts.admincount}</p>
              <p className="text-white text-opacity-90">Total Active Admins</p>
            </div>
            )}
            <div className="animate__animated animate__fadeIn bg-yellow-500 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-200">
