  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="mt-6">
          <input type="time" className="border rounded-lg px-4 py-2 mr-2" />
          <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full">
            Disable
          </button>
          <button className="ml-2 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full">
            Activate Rider
          </button>
        </div>
      </div>
